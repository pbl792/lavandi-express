...
<section class="portada-principal">
    <div class="capa-oscura-portada">
        <div class="caja-texto-portada">
            <span class="nota-superior">✨ Tu lavandería de confianza en Alcobendas</span>
            <h1 class="titulo-enorme">Ropa impecable,<br><span class="resaltado-amarillo">sin mover un dedo.</span></h1>
            <p class="descripcion-portada">Recogemos tu colada a domicilio y te la entregamos limpia, seca y doblada en 24h.</p>
            <div class="grupo-botones">
                <a href="servicios.php" class="boton-azul-relleno">Ver Precios</a>
                <a href="contactos.php" class="boton-blanco-borde">Pedir Recogida</a>
            </div>
        </div>
    </div>
</section>
...
<section class="contenedor-web seccion-ventajas">
    <div class="lista-ventajas">
        <div class="bloque-ventaja">
            ...
            <h4>Envío Gratis</h4>
            <p>En pedidos superiores a 20€ en toda la zona.</p>
        </div>
        <div class="bloque-ventaja">
            <div class="circulo-icono"><i class="bi bi-clock-history"></i></div>
            <h4>Express 24h</h4>
            <p>Tu ropa lista de un día para otro sin esperas.</p>
        </div>
        <div class="bloque-ventaja">
            <div class="circulo-icono"><i class="bi bi-shield-check"></i></div>
            <h4>Garantía Total</h4>
            <p>Cuidamos tus prendas como si fueran nuestras.</p>
        </div>
    </div>
</section>
...
<section class="seccion-gris-claro">
    <div class="contenedor-web">
        <h2 class="titulo-centrado">Nuestros Servicios Top</h2>
        <div class="rejilla-servicios">
            
            <div class="tarjeta-servicio">
                <div class="contenedor-foto">
                    <img src="img/lavado-seco.jpg" alt="Lavado Seco">
                </div>
            ...
            <div class="tarjeta-servicio">
                <div class="contenedor-foto">
                    <img src="img/planchado.jpg" alt="Planchado">
                </div>
                <div class="detalles-servicio">
                    <h3>Planchado Pro</h3>
